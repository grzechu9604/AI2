...
using AILibrary.Controllers.Helpers;
...
namespace AILibrary.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private void DelegateUserDeletion(ApplicationUser userToDelete)
        {
            long intervalInHours = Convert.ToInt64(ConfigurationManager.AppSettings["hoursToDeleteUnconfirmedAccount"]);

            var deletionExecutor = new DeleteAccountExecutor()
            {
                Manager = UserManager,
                UserToDelete = userToDelete
            };

            deletionExecutor.SetIntervalUsingHours(intervalInHours);
            deletionExecutor.DelegateDelete();
        }
        #endregion
    }
}